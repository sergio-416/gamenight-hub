...
@Module({
	...
	providers: [AuthService, FirebaseAuthGuard, WebSocketAuthGuard, FirebaseAdminProvider],
	exports: [AuthService, FirebaseAuthGuard, WebSocketAuthGuard, FirebaseAdminProvider],
})
