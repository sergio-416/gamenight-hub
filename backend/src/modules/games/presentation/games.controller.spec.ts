...
describe("GamesController", () => {
  ...
  describe("GET /games/:id", () => {
    it("should return single game by id", async () => {
      ...
      expect(mockGamesService.findOne).toHaveBeenCalledWith(
        "uuid-123",
        MOCK_UID
      );
    });
  ...
  describe("GET /games/:id/enriched", () => {
    it("should return enriched game with bgg stats and recommendations", async () => {
      ...
      expect(mockGamesService.findOneEnriched).toHaveBeenCalledWith(
        "uuid-123",
        MOCK_UID
      );
    });
  ...
  describe("DELETE /games/:id", () => {
    it("should soft-delete game and return deleted game data", async () => {
      ...
      expect(mockGamesService.remove).toHaveBeenCalledWith(
        "uuid-123",
        MOCK_UID
      );
    });
