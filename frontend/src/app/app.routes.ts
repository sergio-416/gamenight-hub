...
export const routes: Routes = [
	...
	},
	{
		...
		loadComponent: () =>
			import("./features/collection/components/import-game/import-game").then(
				(m) => m.ImportGame,
			),
		providers: [provideTranslocoScope("collection")],
	},
	...
	},
	{
		path: "collection/:id",
		loadComponent: () =>
			import("./features/collection/components/game-detail/game-detail").then(
				(m) => m.GameDetail,
			),
		providers: [provideTranslocoScope("collection")],
	},
	{
		path: "game-nights",
		loadComponent: () =>
			import("./features/game-nights/game-nights").then((m) => m.GameNights),
	...
	},
	{
		...
		loadComponent: () =>
			import("./features/profile/profile-setup/profile-setup").then(
				(m) => m.ProfileSetup,
			),
	...
	},
	{
		...
		canActivate: [authGuard, profileCompleteGuard],
		loadComponent: () =>
			import("./features/profile/profile-me/profile-me").then(
				(m) => m.ProfileMe,
			),
		providers: [provideTranslocoScope("profile")],
	},
	...
	},
	{
		...
		loadComponent: () =>
			import("./features/profile/profile-public/profile-public").then(
				(m) => m.ProfilePublic,
			),
		providers: [provideTranslocoScope("profile")],
	},
	...
	},
	{
		path: "auth/waiting",
		loadComponent: () =>
			import("./features/auth/auth-waiting/auth-waiting").then(
				(m) => m.AuthWaiting,
			),
		providers: [provideTranslocoScope("auth")],
	},
	...
	},
	{
		...
		loadComponent: () =>
			import("./features/create-event/create-event").then((m) => m.CreateEvent),
	...
	},
	{
		...
		providers: [
			provideTranslocoScope("events"),
			provideTranslocoScope("create-event"),
		],
	},
	{
		path: "features",
		loadChildren: () =>
			import("./features/feature-tour/feature-tour.routes").then(
				(m) => m.featureTourRoutes,
			),
