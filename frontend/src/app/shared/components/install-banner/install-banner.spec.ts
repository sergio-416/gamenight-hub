...
async function renderBanner(pwaService: ReturnType<typeof makePwaInstallService>) {
	return render(InstallBanner, {
		providers: [provideTranslocoTesting(), { provide: PwaInstallService, useValue: pwaService }],
	});
}
