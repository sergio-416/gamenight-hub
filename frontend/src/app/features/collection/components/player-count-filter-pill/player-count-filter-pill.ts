...
export class PlayerCountFilterPill {
	...
	readonly #any = translateSignal(
		"filters.playersAny",
		{},
		{ scope: "collection" },
	);
	readonly #one = translateSignal(
		"filters.players1",
		{},
		{ scope: "collection" },
	);
	readonly #two = translateSignal(
		"filters.players2",
		{},
		{ scope: "collection" },
	);
	readonly #three = translateSignal(
		"filters.players3",
		{},
		{ scope: "collection" },
	);
	readonly #four = translateSignal(
		"filters.players4",
		{},
		{ scope: "collection" },
	);
	readonly #five = translateSignal(
		"filters.players5",
		{},
		{ scope: "collection" },
	);
	readonly #sixPlus = translateSignal(
		"filters.players6Plus",
		{},
		{ scope: "collection" },
	);
