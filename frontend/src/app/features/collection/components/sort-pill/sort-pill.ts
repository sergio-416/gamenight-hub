...
export class SortPill {
	...
	private readonly nameAscLabel = translateSignal("filters.sortNameAsc", {}, { scope: "collection" });
	private readonly nameDescLabel = translateSignal("filters.sortNameDesc", {}, { scope: "collection" });
