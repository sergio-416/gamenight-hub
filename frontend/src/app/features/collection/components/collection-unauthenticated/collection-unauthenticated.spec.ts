...
describe("CollectionUnauthenticated", () => {
	...
	describe("hero section", () => {
		it("should display the collection page heading", () => {
			expect(
				screen.getByRole("heading", { name: /your board game collection/i }),
			).toBeTruthy();
		});

		it("should describe what the collection feature does", () => {
			expect(
				screen.getByText(/sign in to start building your collection/i),
			).toBeTruthy();
		});
	...
	describe("features section", () => {
		it("should display the Import feature", () => {
			...
			expect(
				screen.getByText(/add any game to your personal library/i),
			).toBeTruthy();
		});
