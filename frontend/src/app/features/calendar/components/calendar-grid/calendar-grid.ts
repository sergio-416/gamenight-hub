...
export class CalendarGrid {
	...
	readonly #sunS = translateSignal(
		"weekdaysShort.sun",
		{},
		{ scope: "calendar" },
	);
	readonly #monS = translateSignal(
		"weekdaysShort.mon",
		{},
		{ scope: "calendar" },
	);
	readonly #tueS = translateSignal(
		"weekdaysShort.tue",
		{},
		{ scope: "calendar" },
	);
	readonly #wedS = translateSignal(
		"weekdaysShort.wed",
		{},
		{ scope: "calendar" },
	);
	readonly #thuS = translateSignal(
		"weekdaysShort.thu",
		{},
		{ scope: "calendar" },
	);
	readonly #friS = translateSignal(
		"weekdaysShort.fri",
		{},
		{ scope: "calendar" },
	);
	readonly #satS = translateSignal(
		"weekdaysShort.sat",
		{},
		{ scope: "calendar" },
	);
