...
export class CategoryFilterBar {
	...
	readonly #all = translateSignal('categories.all', {}, { scope: 'game-nights' });
	readonly #strategy = translateSignal('categories.strategy', {}, { scope: 'game-nights' });
	readonly #rpg = translateSignal('categories.rpg', {}, { scope: 'game-nights' });
	readonly #party = translateSignal('categories.party', {}, { scope: 'game-nights' });
	readonly #classic = translateSignal('categories.classic', {}, { scope: 'game-nights' });
	readonly #cooperative = translateSignal('categories.cooperative', {}, { scope: 'game-nights' });
	readonly #trivia = translateSignal('categories.trivia', {}, { scope: 'game-nights' });
	readonly #miniatures = translateSignal('categories.miniatures', {}, { scope: 'game-nights' });
	readonly #family = translateSignal('categories.family', {}, { scope: 'game-nights' });
	readonly #other = translateSignal('categories.other', {}, { scope: 'game-nights' });
	readonly #fallback = translateSignal('categories.fallback', {}, { scope: 'game-nights' });
