...
const EN_SHARED = {
	...
	xp: {
		badge: {
			levelShort: 'Lv.{{ level }}',
			tooltip: 'Level {{ level }} \u00b7 {{ title }} \u00b7 {{ current }}/{{ next }} XP',
			ariaLabel: 'XP Level',
		},
		feedback: {
			xpAwarded: '+{{ amount }} XP',
	...
	errors: {
		...
		openEventsExist: 'Please close your open events before deleting your account.',
		locationNotFound: 'Location not found.',
		bggApiError: 'BoardGameGeek is temporarily unavailable. Please try again later.',
	},
};
...
const EN_HOME = {
	hero: {
		...
		titleAfter: '?',
		subtitle: 'Discover local game nights or host your own session. Create your collection. Play.',
	...
	features: {
		perks: {
			title: 'Member Perks',
			description: 'Unlock exclusive benefits and rewards as you grow your community presence',
			link: 'Learn more \u2192',
		},
		xp: {
			title: 'XP & Levels',
			description: 'Earn experience points for every game night and watch your level climb',
			link: 'Learn more \u2192',
		},
		achievements: {
			title: 'Achievements',
			description: 'Collect badges that showcase your gaming milestones and dedication',
			link: 'Learn more \u2192',
		},
	},
	support: {
...
const EN_AUTH = {
	...
	callback: {
		...
		prompt: {
			instruction: 'Please enter the email address you used to request the sign-in link.',
			emailPlaceholder: 'Your email',
			emailLabel: 'Your email',
			continue: 'Continue',
		},
	...
	register: {
		...
		success: {
			...
			message: 'Thanks for applying! Our team will review your request and reach out to',
...
const EN_STATS = {
	unauthenticated: {
		...
		features: {
			categories: {
				title: 'Categories',
				description: 'See which game categories make up the bulk of your collection',
			},
			growth: {
				title: 'Growth',
				description: 'Track how your collection has grown month by month over time',
			},
			complexity: {
				title: 'Complexity',
				description: 'Understand the complexity spread across your entire library',
			},
		},
	},
	organiser: {
...
const EN_CREATE_EVENT = {
	...
	stepGame: {
		...
		descriptionPlaceholder: "Tell everyone what's special about this session...",
...
const EN_FEATURE_TOUR = {
	...
	xp: {
		title: 'XP & Levels',
		description: 'Earn experience points every time you engage with the community.',
		howYouEarn: {
...
const EN_EVENTS = {
	...
	editWarning: {
		tooManyPlayers: "This game supports up to {{ max }} players \u2014 you've set {{ current }}",
		tooFewPlayers: "This game requires at least {{ min }} players \u2014 you've set {{ current }}",
	},
	toast: {
...
const EN_COLLECTION = {
	header: {
		title: 'My Collection',
		subtitleSingular: 'You have {{ count }} game in your library. Keep playing!',
	...
	unauthenticated: {
		...
		featureImportDesc: 'Search BoardGameGeek and add any game to your personal library in seconds',
		...
		featureTrackDesc: 'See stats and insights across your entire collection at a glance',
	},
	addToLibrary: {
	...
	removeConfirmMessage: 'Remove "{{ name }}" from your collection? This can\'t be undone.',
